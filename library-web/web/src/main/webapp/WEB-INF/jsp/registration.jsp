...
<body>
	...
	<h1>
		<fmt:message key="page.registration.header" />
		:
	</h1>
	...
	<div id="registration">
		...
		<div id="registrationForm" class="registrationForm">
			...
			<form action="${pageContext.request.contextPath}/registration"
				...
				</label><br> <label for="email"> <fmt:message
						key="page.registration.email" />: <input type="text" name="email"
					id="email" required>
				</label><br> <label for="password"> <fmt:message
						key="page.registration.password" />: <input type="password"
					name="password" id="password" required>
				</label><br> <select name="role" id="role">
		...
		<div id="errors" class="errors">
			...
			<c:if test="${not empty requestScope.fail}">
				<div style="color: red">
					<span>${requestScope.fail}</span> <br>
				</div>
			</c:if>
		</div>
