...
<div id="header" class="header">
	<div>
		<a href="${pageContext.request.contextPath}/books"> <img id="logo"
			class="logo"
			src="${pageContext.request.contextPath}/resources/img/library-logo.png">
		</a>
	</div>
	<div id="params" class="params">

		<div id="locale" class="locale">
			<form action="${pageContext.request.contextPath}/locale"
				method="post">
